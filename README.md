...
Developed an interactive Power BI dashboard to analyze e-commerce sales performance, profit trends, and customer behavior using real-world transactional data. The goal was to uncover key business insights and support data-driven decision-making.

❓ Problem Statement

Businesses often struggle to track sales performance, identify profitable categories, and understand customer contribution to revenue. This project aims to solve these challenges through interactive data visualization.
...
Contains sales, profit, customer, and regional data
📈 Key Insights
